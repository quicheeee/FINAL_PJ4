    ...
    public static class TestCase {
        ...
        public void testExpectedFive() {
            ...
            String expected = "Welcome to the messaging platform!" + System.lineSeparator() +
                    ...
                    "What message would you like to send?" + System.lineSeparator() +
        ...
        public void testCaseSix() {
            ...
            String expected = "Welcome to the messaging platform!" + System.lineSeparator() +
                    ...
                    "Please enter customer you are searching for:" +
                    System.lineSeparator() + "1. spongebob@gmail.com\n" + "Please select a customer to message:" +
                    System.lineSeparator() +
                    "1. The Krusty Krab\n" + "Please select a store:" + System.lineSeparator() +
                    ...
                    "1. Edit a message\n" +
                    "2. Delete a message\n" + "3. Back to menu" + System.lineSeparator() + "Choose Message Number:"
                    + System.lineSeparator() +
                    ...
                    System.lineSeparator() +
                    "Please input what you want to filter:" + System.lineSeparator() +
                    "Please enter the replacement string or hit enter to choose default (****):"
                    + System.lineSeparator() + "\n" + "What action would you like to take:\n" +
                    "1. Send a new message\n" + "2. View messages\n" + "3. Block a User\n" + "4. Export\n" +
                    "5. Import\n" +
                    "6. Create a Store\n" + "7. Delete Account\n" + "8. Add Filters\n" + "9. Exit" +
            ...
            //krusty logs in as a seller, views a message from spongebob,
            // sends a message to spongebob by searching for him,
            // sends a message, edits the message, then adds a filter for the word "ARGHH" so it says "*pirate noise",
            // views the message
        ...
        public void testCaseSeven() {
            ...
            String expected = "Welcome to the messaging platform!" + System.lineSeparator() +
                    ...
                    "3. Block a User\n" + "4. Export\n" + "5. Import\n" + "6. Delete Account\n" +
                    "7. Add Filters\n" +
                    "8. Exit" + System.lineSeparator() + "Num                       Customer           " +
                    "              Seller                          Store New\n" +
                    "  1                      Spongebob                         Krusty                " +
                    "The Krusty Krab   Y\n" +
                    ...
                    "     The Krusty Krab   N\n" +
                    "Which conversation would you like to view:" + System.lineSeparator() +
                    "1  [Krusty] Greetings Spongebob! ARGHHH!!!" +
                    "\n" + "Actions:\n" + "1. Edit a message\n" + "2. Delete a message\n" +
                    "3. Back to menu" + System.lineSeparator() +
                    "\n" + "What action would you like to take:\n" + "1. Send a new message\n"
                    + "2. View conversations\n" + "3. Block a User\n" +
                    ...
                    "Please input the file path of the text file to import:"
                    + System.lineSeparator() + "File could not be read\n" + "What action would you like to take:\n"
                    + "1. Send a new message\n" +
                    "2. View conversations\n" + "3. Block a User\n" + "4. Export\n" + "5. Import\n" +
                    "6. Delete Account\n" +
                    "7. Add Filters\n" + "8. Exit" + System.lineSeparator() + "Please search user you want to block:"
                    + System.lineSeparator() +
                    "1. bob@gmail.com\n" + "Please select a user to block:" + System.lineSeparator() +
                    "The block was set!\n" + "What action would you like to take:\n" +
                    "1. Send a new message\n" + "2. View conversations\n" + "3. Block a User\n" +
                    "4. Export\n" + "5. Import\n" +
                    "6. Delete Account\n" + "7. Add Filters\n" + "8. Exit" + System.lineSeparator() +
...
// spongebob logs in, views messages, puts an invalid input, then views correct message from krusty,
// deletes the message,
...
// the conversation but is incorrect, then blocks user (seller) bob then tries to adds invalid input (letter to exit)
        ...
        public void testCaseEight() {
            ...
            String expected = "Welcome to the messaging platform!" + System.lineSeparator() +
                    ...
                    + System.lineSeparator() +
                    "Please enter customer you are searching for:" + System.lineSeparator()
                    + "No customers match" + System.lineSeparator() +
                    "\n" + "What action would you like to take:\n" + "1. Send a new message\n"
                    + "2. View messages\n" +
                    "3. Block a User\n" + "4. Export\n" + "5. Import\n" + "6. Create a Store\n"
                    + "7. Delete Account\n" +
                    ...
                    "Bob's Burgers   N\n" +
                    "Which conversation would you like to import to:" + System.lineSeparator() +
                    "Please input the file path of the text file to import:" + System.lineSeparator() +
                    "Your message has been imported!\n" +
                    "What action would you like to take:\n" + "1. Send a new message\n" + "2. View messages\n"
                    + "3. Block a User\n" +
                    "4. Export\n" + "5. Import\n" + "6. Create a Store\n" + "7. Delete Account\n" + "8. Add Filters\n" +
                    "9. Exit"
                    + System.lineSeparator() + "What would you like your store to be named?" + System.lineSeparator() +
                    "Store added.\n" +
                    "What action would you like to take:\n" + "1. Send a new message\n" + "2. View messages\n" +
                    "3. Block a User\n" +
                    "4. Export\n" + "5. Import\n" + "6. Create a Store\n" + "7. Delete Account\n" + "8. Add Filters\n"
            ...
            // Seller bob logs in with email and passwords, tries to send message, searches for spongebob,
            // can't find spongebob,
            // searches for karen
        ...
        public void testCaseNine() {
            ...
            String expected = "Welcome to the messaging platform!" + System.lineSeparator() +
                    ...
                    "  2                          Karen                            Bob             " +
                    "    Bob's Falafels   N\n" +
                    "Which conversation would you like to export:" + System.lineSeparator() +
                    "Please input a file path to write to ending in .csv"
                    + System.lineSeparator() + "\n" + "What action would you like to take:\n" +
                    "1. Send a new message\n" + "2. View conversations\n" +
                    "3. Block a User\n" + "4. Export\n" + "5. Import\n" + "6. Delete Account\n" +
                    "7. Add Filters\n" + "8. Exit"
                    + System.lineSeparator() + "Num                       Customer                    " +
                    "     Seller                          Store New\n" +
                    "  1                          Karen                            Bob                 " +
                    " Bob's Burgers   Y\n" +
                    "  2                          Karen                            Bob                 " +
